          ...
          <section className="max-w-2xl mx-auto">
            ...
            >
              {pendingContent?.map((item) => (
                ...
                >
                  {/* Watermark */}
                  <span className="absolute top-0 right-2 text-sm font-bold text-green-600 opacity-20 select-none pointer-events-none">
            ...
            >
              ...
              {contents?.map((item) => (
                ...
                >
                  ...
                  <span
                    className={`absolute bottom-2 right-2 text-xs font-bold opacity-20 select-none pointer-events-none ${
                      item.group === "group1"
                        ? "text-green-600"
                        : "text-yellow-600"
                    }`}
